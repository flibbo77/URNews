...
AjaxSolr.PagerWidget = AjaxSolr.AbstractWidget.extend(
  ...
  pageLinkOrSpan: function (page, classnames, text) {
    ...
    if (page && page != this.currentPage) {
      return $('<a href="#" class="pagerLink"></a>').html(text).attr('rel', this.relValue(page)).addClass(classnames[1]).click(this.clickHandler(page));
    }
    else {
      return $('<span class="pagerLink"></span>').html(text).addClass(classnames.join(' '));
    }
  },
   ...
   */
  perPage: function () {
    return parseInt(this.manager.response.responseHeader && this.manager.response.responseHeader.params && this.manager.response.responseHeader.params.rows || this.manager.store.get('rows').val() || 5);
  },
